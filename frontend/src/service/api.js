...
export const penugasanAPI = {
  ...
  getSatpam: () => apiClient.get("/penugasan/satpam/all"),
  createSatpam: (data) => apiClient.post("/penugasan/satpam", data),
  updateSatpam: (id, data) => apiClient.put(`/penugasan/satpam/${id}`, data),
  deleteSatpam: (id) => apiClient.delete(`/penugasan/satpam/${id}`),
